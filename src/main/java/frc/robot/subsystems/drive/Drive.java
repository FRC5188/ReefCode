// Code modified from AdvantageKit TalonFX Swerve Template (v4.0.1):
...
public class Drive extends SubsystemBase {
  ...
  // PathPlanner config constants to use if we can't read in the path planner json
  // file
  ...
  public Drive(
    ...
    AutoBuilder.configure(
        ...
        this::runVelocity, // Method that will drive the robot given ROBOT RELATIVE ChassisSpeeds. Also
  ...
  public void periodic() {
    ...
    // Update gyro alert
    gyroDisconnectedAlert.set(!gyroInputs.connected && HardwareConstants.currentMode != Mode.SIM);
  }
